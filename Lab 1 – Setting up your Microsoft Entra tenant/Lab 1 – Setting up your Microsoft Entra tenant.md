...
17. In the **Microsoft Entra admin center** navigate to **Identity**
    then expand **Users**, click **All Users** then click on **New
    User** then click on **Create new user**.

![](./media/image11.png)

18. Enter the following information under **Basics**: 
...
19. Under **Properties**, scroll down and select **United States** as
    **Usage location**.

![](./media/image13.png)

20. Under **Assignment** tab, select **Add role**.

![A screenshot of a computer Description automatically
generated](./media/image14.png)

21. Select **Global Administrator** and click **Select**.

![A screenshot of a computer Description automatically
generated](./media/image15.png)

22. Then select **Review + Create**.

![](./media/image16.png)

23. Note the **User principal name** and **Password**, and then select
    **Create**.

![A screenshot of a computer Description automatically
generated](./media/image17.png)

24. Open an In Private / Incognito session in your browser and login to
...
25. When prompted, update the password to **+++Pa$$.w0rd@123+++**. Then
    select **Sign in**.

![A screenshot of a login page Description automatically
generated](./media/image18.png)

26. Open a browser and navigate to the URL —
    **+++https://www.microsoft.com/en-us/download/details.aspx?id=47594+++**

27. Click **Download** and then select **Open file**.

![A screenshot of a computer Description automatically
generated](./media/image19.png)

28. Once installed, the **Microsoft Azure AD Connect** configuration
...
30. On the Install required components page click **Install**. 

![A screenshot of a computer Description automatically
generated](./media/image22.png)

31. At the **User sign-in** page, choose **Password Hash
...
32. In the Username enter **+++meconnect@+++** and paste Tenant name and
    for the password enter **+++Pa$$.w0rd@123+++**. Then select
    **Next**.

![](./media/image24.png)

33. If you get a prompt that the content is blocked by Internet Explorer
    Enhanced Security Configuration, select **Add**.

![](./media/image25.png)

34. On the Trusted sites prompt, again select **Add** and then
    **Close**. Do these for all the required sites.

![](./media/image26.png)

35. If asked, provide the tenant credentials again.

36. ![A screenshot of a computer Description automatically
    generated](./media/image27.png)

37. On the connect your directories page click **Add directory**. 

![Graphical user interface, text, application Description automatically
generated](./media/image28.png)

38.  On the **AD Forest account** window click **Create new account**
    and enter the login credentials of your VM, i.e. the domain name and
    the password and select **Next**.

    ![](./media/image29.png)

39. Back on the **Connect your directories** page click on **Next.**

    ![](./media/image30.png)

40. On the Azure AD sign in configuration page select the check box for
    **Continue without matching all UPN suffixes to verified domains**
    check box and click **Next**. 

  ![](./media/image31.png)

41. On the **Domain and OU filtering** page select the Sync **selected
    domains and OUs** radio button and only select the **IT** OU and
    then click on **Next**

    ![](./media/image32.png)

42. On the **Uniquely identify your users**, leave the default values
    and click on **Next**.

43. On the **Filter users and devices**, leave the default values and
    click on **Next**.

44. On the **Optional features**, leave the default values and click on
    **Next**.

45. On the **Ready to configure** page, click on the **Install** button.

![](./media/image33.png)

46. Once the installation is complete, select **Exit**. 
